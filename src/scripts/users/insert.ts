...
const userDTO: UserDTO = {
    ...
    groupProfile: {
        ...
        personalExperience: {
            description: "I was part of a design thinking workshop in Milan with six other participants. My role naturally became keeping everyone connected and energized throughout the intensive three-day session. When our brainstorming session got tense because we couldn't agree on a direction, I cracked a joke about Italian bureaucracy to lighten the mood and get everyone laughing again. One participant, Marco, kept dominating our discussions, so I made sure to amplify the ideas of quieter members by saying things like 'That's exactly what Elena was suggesting earlier' or 'Let's build on Chiara's concept.' When we had to choose between two different project approaches, I listened to everyone's concerns, then suggested we combine the best elements of both as a compromise. I noticed that Paolo was quiet during our ideation sessions, so I'd ask him directly: 'Paolo, what's your perspective on this challenge?' I supported another participant's innovative idea for the prototype, helping them develop it further. I appreciated how each person brought something unique to our team dynamic. When two team members disagreed about our presentation strategy, I gently named the tension and checked in with both to understand their perspectives. After the workshop ended, I absolutely wanted to stay in touch with everyone - these connections felt valuable and worth maintaining."
        }
    },
    profileSectionsStatus: {
        ...
        groupPersonalExperience: "completed"
    }
};
